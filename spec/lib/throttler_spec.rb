...
describe ThrottlePolicy::Throttler do
  ...
  it "sets a time unit window size" do
    ...
    one_min              = ThrottlePolicy::Throttler.new(1.minute, stub_time)
  ...
  it "increments the count" do
    t   = ThrottlePolicy::Throttler.new(1.minute, stub_time)
    uid = 123
  ...
  it "tells you when the next time period starts" do
    one_hour  = ThrottlePolicy::Throttler.new(1.hour, stub_time)
