...
describe Resources::Preprocessor do
  ...
  describe Resources::Service do
    it "handles syntax errors using step1" do
      ...
      Resources::Service.new.process(shim, body)
    ...
    it "handles semantic errors using step2" do
      ...
      x = Resources::Service.new.step2(action: "wrong_action",
                                       device: dev,
                                       body: "wrong_body",
                                       resource_id: 0,
    ...
    it "processes resources" do
      ...
      result = Resources::Service.new.process(DeliveryInfoShim.new(chan), body)
