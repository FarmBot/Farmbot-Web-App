{
  ...
  peripherals: {
    -424 => { label: "Lighting",     pin: 7,  mode: 0},
    -425 => { label: "Water",        pin: 8,  mode: 0},
    -426 => { label: "Vacuum",       pin: 9,  mode: 0},
    -427 => { label: "Peripheral 4", pin: 10, mode: 0},
    -428 => { label: "Peripheral 5", pin: 11, mode: 0},
  },
  pin_bindings: [
    {
      sequence_id: nil,
  ...
  sequences: {
    -3040=>{:args=>{:version=>20180209, :locals=>{:kind=>"scope_declaration", :args=>{}}}, :color=>"orange", :name=>"Mount seeder", :kind=>"sequence", :body=>[{:kind=>"move_absolute", :args=>{:speed=>100, :offset=>{:kind=>"coordinate", :args=>{:z=>100, :y=>0, :x=>0}}, :location=>{:kind=>"tool", :args=>{:tool_id=>-2}}}}, {:kind=>"move_absolute", :args=>{:speed=>100, :offset=>{:kind=>"coordinate", :args=>{:z=>0, :y=>0, :x=>0}}, :location=>{:kind=>"tool", :args=>{:tool_id=>-2}}}}, {:kind=>"move_absolute", :args=>{:speed=>100, :offset=>{:kind=>"coordinate", :args=>{:z=>0, :y=>0, :x=>100}}, :location=>{:kind=>"tool", :args=>{:tool_id=>-2}}}}, {:kind=>"move_absolute", :args=>{:speed=>100, :offset=>{:kind=>"coordinate", :args=>{:z=>100, :y=>0, :x=>100}}, :location=>{:kind=>"tool", :args=>{:tool_id=>-2}}}}], :in_use=>true},
    -3041=>{:args=>{:version=>20180209, :locals=>{:kind=>"scope_declaration", :args=>{}}}, :color=>"yellow", :name=>"Pick up seed", :kind=>"sequence", :body=>[{:kind=>"move_absolute", :args=>{:speed=>100, :location=>{:kind=>"tool", :args=>{:tool_id=>-4}}, :offset=>{:kind=>"coordinate", :args=>{:x=>0, :y=>0, :z=>100}}}}, {:kind=>"move_absolute", :args=>{:speed=>100, :location=>{:kind=>"tool", :args=>{:tool_id=>-4}}, :offset=>{:kind=>"coordinate", :args=>{:x=>0, :y=>0, :z=>0}}}}, {:kind=>"write_pin", :args=>{:pin_mode=>0, :pin_value=>1, :pin_number=>{:kind=>"named_pin", :args=>{:pin_id=>-426, :pin_type=>"Peripheral"}}}}, {:kind=>"move_absolute", :args=>{:speed=>100, :location=>{:kind=>"tool", :args=>{:tool_id=>-4}}, :offset=>{:kind=>"coordinate", :args=>{:x=>0, :y=>0, :z=>100}}}}], :in_use=>true},
    -3043=>{:args=>{:version=>20180209, :locals=>{:kind=>"scope_declaration", :args=>{}}}, :color=>"green", :name=>"Plant Spinach", :kind=>"sequence", :body=>[{:kind=>"execute", :args=>{:sequence_id=>-3040}}, {:kind=>"execute", :args=>{:sequence_id=>-3041}}, {:kind=>"move_absolute", :args=>{:speed=>100, :location=>{:kind=>"point", :args=>{:pointer_type=>"Plant", :pointer_id=>-21908}}, :offset=>{:kind=>"coordinate", :args=>{:x=>0, :y=>0, :z=>-700}}}}, {:kind=>"write_pin", :args=>{:pin_value=>0, :pin_mode=>0, :pin_number=>{:kind=>"named_pin", :args=>{:pin_type=>"Peripheral",:pin_id=>-426}}}}, {:kind=>"move_relative", :args=>{:x=>0, :y=>0, :z=>100, :speed=>100}}, {:kind=>"execute", :args=>{:sequence_id=>-3046}}], :in_use=>true},
    -3044=>{:args=>{:version=>20180209, :locals=>{:kind=>"scope_declaration", :args=>{}}}, :color=>"purple", :name=>"Mount Watering Nozzle", :kind=>"sequence", :body=>[{:kind=>"move_absolute", :args=>{:speed=>100, :offset=>{:kind=>"coordinate", :args=>{:z=>100, :y=>0, :x=>0}}, :location=>{:kind=>"tool", :args=>{:tool_id=>-3}}}}, {:kind=>"move_absolute", :args=>{:speed=>100, :offset=>{:kind=>"coordinate", :args=>{:z=>0, :y=>0, :x=>0}}, :location=>{:kind=>"tool", :args=>{:tool_id=>-3}}}}, {:kind=>"move_absolute", :args=>{:speed=>100, :offset=>{:kind=>"coordinate", :args=>{:z=>0, :y=>0, :x=>100}}, :location=>{:kind=>"tool", :args=>{:tool_id=>-3}}}}, {:kind=>"move_absolute", :args=>{:speed=>100, :offset=>{:kind=>"coordinate", :args=>{:z=>100, :y=>0, :x=>100}}, :location=>{:kind=>"tool", :args=>{:tool_id=>-3}}}}], :in_use=>true},
    -3045=>{:args=>{:version=>20180209, :locals=>{:kind=>"scope_declaration", :args=>{}}}, :color=>"pink", :name=>"Light Watering", :kind=>"sequence", :body=>[{:kind=>"write_pin", :args=>{:pin_value=>1, :pin_mode=>0, :pin_number=>{:kind=>"named_pin", :args=>{:pin_type=>"Peripheral",:pin_id=>-425}}}}, {:kind=>"wait", :args=>{:milliseconds=>5000}}, {:kind=>"write_pin", :args=>{:pin_value=>0, :pin_mode=>0, :pin_number=>{:kind=>"named_pin", :args=>{:pin_type=>"Peripheral",:pin_id=>-425}}}}], :in_use=>true},
    -3046=>{:args=>{:version=>20180209, :locals=>{:kind=>"scope_declaration", :args=>{}}}, :color=>"orange", :name=>"Unmount seeder", :kind=>"sequence", :body=>[{:kind=>"move_absolute", :args=>{:speed=>100, :offset=>{:kind=>"coordinate", :args=>{:z=>100, :y=>0, :x=>100}}, :location=>{:kind=>"tool", :args=>{:tool_id=>-2}}}}, {:kind=>"move_absolute", :args=>{:speed=>100, :offset=>{:kind=>"coordinate", :args=>{:z=>0, :y=>0, :x=>100}}, :location=>{:kind=>"tool", :args=>{:tool_id=>-2}}}}, {:kind=>"move_absolute", :args=>{:speed=>100, :offset=>{:kind=>"coordinate", :args=>{:z=>0, :y=>0, :x=>0}}, :location=>{:kind=>"tool", :args=>{:tool_id=>-2}}}}, {:kind=>"move_absolute", :args=>{:speed=>100, :offset=>{:kind=>"coordinate", :args=>{:z=>100, :y=>0, :x=>0}}, :location=>{:kind=>"tool", :args=>{:tool_id=>-2}}}}], :in_use=>true},
    -3047=>{:args=>{:version=>20180209, :locals=>{:kind=>"scope_declaration", :args=>{}}}, :color=>"purple", :name=>"Unmount watering nozzle", :kind=>"sequence", :body=>[{:kind=>"move_absolute", :args=>{:speed=>100, :location=>{:kind=>"tool", :args=>{:tool_id=>-3}}, :offset=>{:kind=>"coordinate", :args=>{:x=>100, :y=>0, :z=>100}}}}, {:kind=>"move_absolute", :args=>{:speed=>100, :location=>{:kind=>"tool", :args=>{:tool_id=>-3}}, :offset=>{:kind=>"coordinate", :args=>{:x=>100, :y=>0, :z=>0}}}}, {:kind=>"move_absolute", :args=>{:speed=>100, :location=>{:kind=>"tool", :args=>{:tool_id=>-3}}, :offset=>{:kind=>"coordinate", :args=>{:x=>0, :y=>0, :z=>0}}}}, {:kind=>"move_absolute", :args=>{:speed=>100, :location=>{:kind=>"tool", :args=>{:tool_id=>-3}}, :offset=>{:kind=>"coordinate", :args=>{:x=>0, :y=>0, :z=>100}}}}], :in_use=>true},
    -3048=>{:args=>{:version=>20180209, :locals=>{:kind=>"scope_declaration", :args=>{}}}, :color=>"blue", :name=>"Water spinach", :kind=>"sequence", :body=>[{:kind=>"execute", :args=>{:sequence_id=>-3044}}, {:kind=>"move_absolute", :args=>{:speed=>100, :offset=>{:kind=>"coordinate", :args=>{:z=>0, :y=>0, :x=>0}}, :location=>{:kind=>"point", :args=>{:pointer_id=>-21908, :pointer_type=>"Plant"}}}}, {:kind=>"execute", :args=>{:sequence_id=>-3045}}, {:kind=>"execute", :args=>{:sequence_id=>-3047}}], :in_use=>true}
  },
