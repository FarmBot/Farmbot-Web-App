...
ALTER SEQUENCE public.arg_names_id_seq
OWNED BY public.arg_names.id;
...
ALTER SEQUENCE public.arg_sets_id_seq
OWNED BY public.arg_sets.id;
...
(
    ...
    ALTER SEQUENCE public.delayed_jobs_id_seq
    OWNED BY public.delayed_jobs.id;
    ...
    CACHE 1;
        ...
        ALTER SEQUENCE public.device_serial_numbers_id_seq
        OWNED BY public.device_serial_numbers.id;
        ...
        (
            id integer NOT NULL,
            name character varying DEFAULT 'Farmbot'
            ::character varying,
    ...
    fbos_version character varying
            (15),
    ...
    sync_status character varying
                (12),
    wifi_level character varying
                (12),
    soc_temp character varying
                (12),
    ...
    CACHE 1;
                ...
                ALTER SEQUENCE public.diagnostic_dumps_id_seq
                OWNED BY public.diagnostic_dumps.id;
    ...
    CACHE 1;
                    ...
                    ALTER SEQUENCE public.edge_nodes_id_seq
                    OWNED BY public.edge_nodes.id;
    ...
    CACHE 1;
                        ...
                        ALTER SEQUENCE public.farm_events_id_seq
                        OWNED BY public.farm_events.id;
    ...
    CACHE 1;
                            ...
                            ALTER SEQUENCE public.farmware_envs_id_seq
                            OWNED BY public.farmware_envs.id;
    ...
    CACHE 1;
                                ...
                                ALTER SEQUENCE public.farmware_installations_id_seq
                                OWNED BY public.farmware_installations.id;
    ...
    update_channel character varying
                                    (7) DEFAULT 'stable'::character varying
);
    ...
    CACHE 1;
                                    ...
                                    ALTER SEQUENCE public.fbos_configs_id_seq
                                    OWNED BY public.fbos_configs.id;
    ...
    CACHE 1;
                                        ...
                                        ALTER SEQUENCE public.firmware_configs_id_seq
                                        OWNED BY public.firmware_configs.id;
    ...
    CACHE 1;
                                            ...
                                            ALTER SEQUENCE public.fragments_id_seq
                                            OWNED BY public.fragments.id;
    ...
    CACHE 1;
                                                ...
                                                ALTER SEQUENCE public.global_configs_id_seq
                                                OWNED BY public.global_configs.id;
    ...
    openfarm_slug character varying
                                                        (280) DEFAULT '50'::character varying NOT NULL,
    plant_stage character varying
                                                        (10) DEFAULT 'planned'::character varying,
    tool_id integer,
    ...
    discarded_at timestamp without time zone
                                                        ...
                                                        (
                                                            ...
                                                            kind character varying(280) DEFAULT 'sequence'
                                                            ::character varying,
    updated_at timestamp without time zone,
    created_at timestamp without time zone,
    migrated_nodes boolean DEFAULT false
                                                            ...
                                                            CREATE VIEW public.in_use_points
                                                            AS
                                                                SELECT points.x,
                                                                    points.y,
                                                                    points.z,
   ...
   FROM
                                                            ((public.edge_nodes
     JOIN public.sequences ON
                                                            ((edge_nodes.sequence_id = sequences.id)))
     JOIN public.points ON
                                                            (((edge_nodes.value)::integer = points.id)))
  WHERE
                                                            ((edge_nodes.kind)::text = 'pointer_id'::text);
    ...
    device_id integer
                                                                ...
                                                                CREATE VIEW public.in_use_tools
                                                                AS
                                                                    ...
                                                                    FROM ((public.edge_nodes
                                                                        ...
                                                                        JOIN public.tools ON (((edge_nodes.value)
                                                                ::integer = tools.id)))
  WHERE
                                                                ((edge_nodes.kind)::text = 'tool_id'::text);
    ...
    CACHE 1;
                                                                ...
                                                                ALTER SEQUENCE public.kinds_id_seq
                                                                OWNED BY public.kinds.id;
    ...
    type character varying
                                                                    (10) DEFAULT 'info'::character varying,
    ...
    CACHE 1;
                                                                    ...
                                                                    ALTER SEQUENCE public.nodes_id_seq
                                                                    OWNED BY public.nodes.id;
    ...
    CACHE 1;
                                                                        ...
                                                                        ALTER SEQUENCE public.peripherals_id_seq
                                                                        OWNED BY public.peripherals.id;
    ...
    CACHE 1;
                                                                            ...
                                                                            ALTER SEQUENCE public.pin_bindings_id_seq
                                                                            OWNED BY public.pin_bindings.id;
                                                                            ...
                                                                            (
                                                                                ...
                                                                                y double precision NOT NULL,
                                                                                z double precision DEFAULT 0.0 NOT NULL,
                                                                                name character varying DEFAULT 'untitled'
                                                                                ::character varying NOT NULL,
    openfarm_slug character varying
                                                                                (280) DEFAULT 'null'::character varying NOT NULL,
    created_at timestamp without time zone,
    updated_at timestamp without time zone
);
    ...
    CACHE 1;
                                                                                ...
                                                                                ALTER SEQUENCE public.plant_templates_id_seq
                                                                                OWNED BY public.plant_templates.id;
    ...
    child_id bigint,
    parent_id bigint,
    parent_arg_name character varying
                                                                                    (50),
    next_id bigint,
    body_id bigint,
    ...
    CACHE 1;
                                                                                    ...
                                                                                    ALTER SEQUENCE public.primary_nodes_id_seq
                                                                                    OWNED BY public.primary_nodes.id;
    ...
    CACHE 1;
                                                                                    ...
                                                                                    ALTER SEQUENCE public.primitive_pairs_id_seq
                                                                                    OWNED BY public.primitive_pairs.id;
    ...
    CACHE 1;
                                                                                    ...
                                                                                    ALTER SEQUENCE public.primitives_id_seq
                                                                                    OWNED BY public.primitives.id;
    ...
    CACHE 1;
                                                                                        ...
                                                                                        ALTER SEQUENCE public.regimen_items_id_seq
                                                                                        OWNED BY public.regimen_items.id;
    ...
    CACHE 1;
                                                                                                ...
                                                                                                ALTER SEQUENCE public.saved_gardens_id_seq
                                                                                                OWNED BY public.saved_gardens.id;
    ...
    CACHE 1;
                                                                                                        ...
                                                                                                        ALTER SEQUENCE public.sensors_id_seq
                                                                                                        OWNED BY public.sensors.id;
                                                                                                        ...
                                                                                                        CREATE VIEW public.sequence_usage_reports
                                                                                                        AS
                                                                                                            SELECT sequences.id AS sequence_id,
                                                                                                                ( SELECT count(*) AS count
                                                                                                                FROM public.edge_nodes
                                                                                                                WHERE (((edge_nodes.kind)
                                                                                                        ::text = 'sequence_id'::text) AND
                                                                                                        ((edge_nodes.value)::integer = sequences.id))) AS edge_node_count,
                                                                                                        ( SELECT count(*) AS count
                                                                                                        FROM public.farm_events
                                                                                                        WHERE ((farm_events.executable_id = sequences.id) AND ((farm_events.executable_type)
                                                                                                        ::text = 'Sequence'::text))) AS farm_event_count,
                                                                                                        ( SELECT count(*) AS count
                                                                                                        FROM public.regimen_items
                                                                                                        WHERE (regimen_items.sequence_id = sequences.id))
                                                                                                        AS regimen_items_count
   FROM public.sequences;
    ...
    CACHE 1;
                                                                                                        ...
                                                                                                        ALTER SEQUENCE public.sequences_id_seq
                                                                                                        OWNED BY public.sequences.id;
    ...
    CACHE 1;
                                                                                                        ...
                                                                                                        ALTER SEQUENCE public.standard_pairs_id_seq
                                                                                                        OWNED BY public.standard_pairs.id;
    ...
    CACHE 1;
                                                                                                            ...
                                                                                                            ALTER SEQUENCE public.token_issuances_id_seq
                                                                                                            OWNED BY public.token_issuances.id;
    ...
    CACHE 1;
                                                                                                            ...
                                                                                                            ALTER SEQUENCE public.tools_id_seq
                                                                                                            OWNED BY public.tools.id;
    ...
    CACHE 1;
                                                                                                                    ...
                                                                                                                    ALTER SEQUENCE public.web_app_configs_id_seq
                                                                                                                    OWNED BY public.web_app_configs.id;
    ...
    updated_at timestamp without time zone NOT NULL,
    name character varying
                                                                                                                        (80) DEFAULT 'Webcam Feed'::character varying
);
    ...
    CACHE 1;
                                                                                                                        ...
                                                                                                                        ALTER SEQUENCE public.webcam_feeds_id_seq
                                                                                                                        OWNED BY public.webcam_feeds.id;
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.arg_names_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.arg_sets_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.delayed_jobs_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.device_serial_numbers_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.devices_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.diagnostic_dumps_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.edge_nodes_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.farm_events_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.farmware_envs_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.fbos_configs_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.firmware_configs_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.fragments_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.global_configs_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.peripherals_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.pin_bindings_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.plant_templates_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.primary_nodes_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.primitive_pairs_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.primitives_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.regimen_items_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.regimens_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.saved_gardens_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.sensor_readings_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.sensors_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.sequences_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.standard_pairs_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.token_issuances_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.web_app_configs_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        SET
                                                                                                                        DEFAULT nextval
                                                                                                                        ('public.webcam_feeds_id_seq'::regclass);
                                                                                                                        ...
                                                                                                                        ADD CONSTRAINT ar_internal_metadata_pkey PRIMARY KEY
                                                                                                                        (key);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.arg_names
                                                                                                                        ADD CONSTRAINT arg_names_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.arg_sets
                                                                                                                        ADD CONSTRAINT arg_sets_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.delayed_jobs
                                                                                                                        ADD CONSTRAINT delayed_jobs_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.device_serial_numbers
                                                                                                                        ADD CONSTRAINT device_serial_numbers_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.devices
                                                                                                                        ADD CONSTRAINT devices_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.diagnostic_dumps
                                                                                                                        ADD CONSTRAINT diagnostic_dumps_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.edge_nodes
                                                                                                                        ADD CONSTRAINT edge_nodes_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.farm_events
                                                                                                                        ADD CONSTRAINT farm_events_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.farmware_envs
                                                                                                                        ADD CONSTRAINT farmware_envs_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.farmware_installations
                                                                                                                        ADD CONSTRAINT farmware_installations_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.fbos_configs
                                                                                                                        ADD CONSTRAINT fbos_configs_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.firmware_configs
                                                                                                                        ADD CONSTRAINT firmware_configs_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.fragments
                                                                                                                        ADD CONSTRAINT fragments_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.global_configs
                                                                                                                        ADD CONSTRAINT global_configs_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.images
                                                                                                                        ADD CONSTRAINT images_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.kinds
                                                                                                                        ADD CONSTRAINT kinds_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.logs
                                                                                                                        ADD CONSTRAINT logs_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.nodes
                                                                                                                        ADD CONSTRAINT nodes_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.peripherals
                                                                                                                        ADD CONSTRAINT peripherals_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.pin_bindings
                                                                                                                        ADD CONSTRAINT pin_bindings_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.plant_templates
                                                                                                                        ADD CONSTRAINT plant_templates_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.points
                                                                                                                        ADD CONSTRAINT points_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.primary_nodes
                                                                                                                        ADD CONSTRAINT primary_nodes_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.primitive_pairs
                                                                                                                        ADD CONSTRAINT primitive_pairs_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.primitives
                                                                                                                        ADD CONSTRAINT primitives_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.regimen_items
                                                                                                                        ADD CONSTRAINT regimen_items_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.regimens
                                                                                                                        ADD CONSTRAINT regimens_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.saved_gardens
                                                                                                                        ADD CONSTRAINT saved_gardens_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ADD CONSTRAINT schema_migrations_pkey PRIMARY KEY
                                                                                                                        (version);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.sensor_readings
                                                                                                                        ADD CONSTRAINT sensor_readings_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.sensors
                                                                                                                        ADD CONSTRAINT sensors_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.sequences
                                                                                                                        ADD CONSTRAINT sequences_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.standard_pairs
                                                                                                                        ADD CONSTRAINT standard_pairs_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.token_issuances
                                                                                                                        ADD CONSTRAINT token_issuances_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.tools
                                                                                                                        ADD CONSTRAINT tools_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.web_app_configs
                                                                                                                        ADD CONSTRAINT web_app_configs_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.webcam_feeds
                                                                                                                        ADD CONSTRAINT webcam_feeds_pkey PRIMARY KEY
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX delayed_jobs_priority ON public.delayed_jobs USING btree
                                                                                                                        (priority, run_at);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_arg_sets_on_fragment_id ON public.arg_sets USING btree
                                                                                                                        (fragment_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_arg_sets_on_node_id ON public.arg_sets USING btree
                                                                                                                        (node_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_device_serial_numbers_on_device_id ON public.device_serial_numbers USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_devices_on_mounted_tool_id ON public.devices USING btree
                                                                                                                        (mounted_tool_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_devices_on_timezone ON public.devices USING btree
                                                                                                                        (timezone);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_diagnostic_dumps_on_device_id ON public.diagnostic_dumps USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_edge_nodes_on_kind_and_value ON public.edge_nodes USING btree
                                                                                                                        (kind, value);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_edge_nodes_on_primary_node_id ON public.edge_nodes USING btree
                                                                                                                        (primary_node_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_edge_nodes_on_sequence_id ON public.edge_nodes USING btree
                                                                                                                        (sequence_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_farm_events_on_device_id ON public.farm_events USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_farm_events_on_end_time ON public.farm_events USING btree
                                                                                                                        (end_time);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_farm_events_on_executable_type_and_executable_id ON public.farm_events USING btree
                                                                                                                        (executable_type, executable_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_farmware_envs_on_device_id ON public.farmware_envs USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_farmware_installations_on_device_id ON public.farmware_installations USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_fbos_configs_on_device_id ON public.fbos_configs USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_firmware_configs_on_device_id ON public.firmware_configs USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_fragments_on_device_id ON public.fragments USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_fragments_on_owner_type_and_owner_id ON public.fragments USING btree
                                                                                                                        (owner_type, owner_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_global_configs_on_key ON public.global_configs USING btree
                                                                                                                        (key);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_images_on_device_id ON public.images USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_logs_on_created_at ON public.logs USING btree
                                                                                                                        (created_at);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_logs_on_device_id ON public.logs USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_logs_on_device_id_and_created_at ON public.logs USING btree
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_logs_on_sent_at ON public.logs USING btree
                                                                                                                        (sent_at);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_logs_on_type ON public.logs USING btree
                                                                                                                        (type);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_logs_on_updated_at ON public.logs USING btree
                                                                                                                        (updated_at);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_logs_on_verbosity ON public.logs USING btree
                                                                                                                        (verbosity);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_logs_on_verbosity_and_type ON public.logs USING btree
                                                                                                                        (verbosity, type);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_nodes_on_fragment_id ON public.nodes USING btree
                                                                                                                        (fragment_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_nodes_on_kind_id ON public.nodes USING btree
                                                                                                                        (kind_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_peripherals_on_device_id ON public.peripherals USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_peripherals_on_mode ON public.peripherals USING btree
                                                                                                                        (mode);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_pin_bindings_on_device_id ON public.pin_bindings USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_pin_bindings_on_sequence_id ON public.pin_bindings USING btree
                                                                                                                        (sequence_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_plant_templates_on_device_id ON public.plant_templates USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_plant_templates_on_saved_garden_id ON public.plant_templates USING btree
                                                                                                                        (saved_garden_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_points_on_device_id ON public.points USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_points_on_discarded_at ON public.points USING btree
                                                                                                                        (discarded_at);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_points_on_id_and_pointer_type ON public.points USING btree
                                                                                                                        (id, pointer_type);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_points_on_meta ON public.points USING gin
                                                                                                                        (meta);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_points_on_tool_id ON public.points USING btree
                                                                                                                        (tool_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_primary_nodes_on_body_id ON public.primary_nodes USING btree
                                                                                                                        (body_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_primary_nodes_on_child_id ON public.primary_nodes USING btree
                                                                                                                        (child_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_primary_nodes_on_next_id ON public.primary_nodes USING btree
                                                                                                                        (next_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_primary_nodes_on_parent_id ON public.primary_nodes USING btree
                                                                                                                        (parent_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_primary_nodes_on_sequence_id ON public.primary_nodes USING btree
                                                                                                                        (sequence_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_primitive_pairs_on_arg_name_id ON public.primitive_pairs USING btree
                                                                                                                        (arg_name_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_primitive_pairs_on_arg_set_id ON public.primitive_pairs USING btree
                                                                                                                        (arg_set_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_primitive_pairs_on_fragment_id ON public.primitive_pairs USING btree
                                                                                                                        (fragment_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_primitive_pairs_on_primitive_id ON public.primitive_pairs USING btree
                                                                                                                        (primitive_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_primitives_on_fragment_id ON public.primitives USING btree
                                                                                                                        (fragment_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_regimen_items_on_regimen_id ON public.regimen_items USING btree
                                                                                                                        (regimen_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_regimen_items_on_sequence_id ON public.regimen_items USING btree
                                                                                                                        (sequence_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_regimens_on_device_id ON public.regimens USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_saved_gardens_on_device_id ON public.saved_gardens USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_sensor_readings_on_device_id ON public.sensor_readings USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_sensors_on_device_id ON public.sensors USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_sequences_on_created_at ON public.sequences USING btree
                                                                                                                        (created_at);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_sequences_on_device_id ON public.sequences USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_standard_pairs_on_arg_name_id ON public.standard_pairs USING btree
                                                                                                                        (arg_name_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_standard_pairs_on_arg_set_id ON public.standard_pairs USING btree
                                                                                                                        (arg_set_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_standard_pairs_on_fragment_id ON public.standard_pairs USING btree
                                                                                                                        (fragment_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_standard_pairs_on_node_id ON public.standard_pairs USING btree
                                                                                                                        (node_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_token_issuances_on_device_id ON public.token_issuances USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_token_issuances_on_exp ON public.token_issuances USING btree
                                                                                                                        (exp);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_token_issuances_on_jti_and_device_id ON public.token_issuances USING btree
                                                                                                                        (jti, device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_tools_on_device_id ON public.tools USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_users_on_agreed_to_terms_at ON public.users USING btree
                                                                                                                        (agreed_to_terms_at);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_users_on_confirmation_token ON public.users USING btree
                                                                                                                        (confirmation_token);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_users_on_device_id ON public.users USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_web_app_configs_on_device_id ON public.web_app_configs USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        CREATE INDEX index_webcam_feeds_on_device_id ON public.webcam_feeds USING btree
                                                                                                                        (device_id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.sensor_readings
                                                                                                                        ADD CONSTRAINT fk_rails_04297fb1ff FOREIGN KEY
                                                                                                                        (device_id) REFERENCES public.devices
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.pin_bindings
                                                                                                                        ADD CONSTRAINT fk_rails_1f1c3b6979 FOREIGN KEY
                                                                                                                        (device_id) REFERENCES public.devices
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.sensors
                                                                                                                        ADD CONSTRAINT fk_rails_92e56bf2fb FOREIGN KEY
                                                                                                                        (device_id) REFERENCES public.devices
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.points
                                                                                                                        ADD CONSTRAINT fk_rails_a62cbb8aca FOREIGN KEY
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.primary_nodes
                                                                                                                        ADD CONSTRAINT fk_rails_bca7fee3b9 FOREIGN KEY
                                                                                                                        (sequence_id) REFERENCES public.sequences
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.farmware_envs
                                                                                                                        ADD CONSTRAINT fk_rails_bdadc396eb FOREIGN KEY
                                                                                                                        (device_id) REFERENCES public.devices
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.diagnostic_dumps
                                                                                                                        ADD CONSTRAINT fk_rails_c5df7fdc83 FOREIGN KEY
                                                                                                                        (device_id) REFERENCES public.devices
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.farmware_installations
                                                                                                                        ADD CONSTRAINT fk_rails_c72f38683f FOREIGN KEY
                                                                                                                        (device_id) REFERENCES public.devices
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.edge_nodes
                                                                                                                        ADD CONSTRAINT fk_rails_c86213fd78 FOREIGN KEY
                                                                                                                        (sequence_id) REFERENCES public.sequences
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.device_serial_numbers
                                                                                                                        ADD CONSTRAINT fk_rails_d052988096 FOREIGN KEY
                                                                                                                        (device_id) REFERENCES public.devices
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.points
                                                                                                                        ADD CONSTRAINT fk_rails_d6f3cdbe9a FOREIGN KEY
                                                                                                                        (device_id) REFERENCES public.devices
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.token_issuances
                                                                                                                        ADD CONSTRAINT fk_rails_e202a61188 FOREIGN KEY
                                                                                                                        (device_id) REFERENCES public.devices
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.devices
                                                                                                                        ADD CONSTRAINT fk_rails_eef5afaff7 FOREIGN KEY
                                                                                                                        (mounted_tool_id) REFERENCES public.tools
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.pin_bindings
                                                                                                                        ADD CONSTRAINT fk_rails_f72ee24d98 FOREIGN KEY
                                                                                                                        (sequence_id) REFERENCES public.sequences
                                                                                                                        (id);
                                                                                                                        ...
                                                                                                                        ALTER TABLE ONLY public.peripherals
                                                                                                                        ADD CONSTRAINT fk_rails_fdaad0007f FOREIGN KEY
                                                                                                                        (device_id) REFERENCES public.devices
                                                                                                                        (id);
