...
0. Set ENV vars like `JS\_FILE\_URL` to real values:
  * `ssh dokku@my_server_name config:set my_app_name DEVISE_SECRET=$(rake secret) JS_FILE_URL=//mycdn.org/farmbot-fronted.js API_HOST=yourdomain.com API_PORT=1234`
