module.exports = {
    ...
    "filter": "фильтр",
    "in slot": "в слоте",
    "Invert axis end-stops. Enable for normally closed (NC), disable for normally open (NO).": "Инвертировать концевые датчики осей. Включите для нормально закрытых датчиков (NC), отключите для нормально открытых датчиков (NO).",
    ...
    "The next item in this Farm Event will run {{timeFromNow}}, but you must first SYNC YOUR DEVICE. If you do not sync, the event will not run.": "следующее действие будет запущено {{timeFromNow}}, но сначала необходимо СИНХРОНИЗИРОВАТЬ робота. Если синхронизации не будет, действие не запустится.",
    ...
    "Export": "Экспорт",
    "Export Account Data": "Экспорт данных аккаунта",
    ...
    "Home button behavior": "Поведение кнопки \"Домой\"",
    ...
    "Send Account Export File (Email)": "Экспортировать данные аккаунта (Email)",
    "Send Message": "Отправить сообщение",
    ...
    "Update": "Обновление",
    "Updating...": "Обновляю...",
    "Upon successful password change, your FarmBot will factory reset allowing you to configure it with the updated credentials. You will also be logged out of other browser sessions. Continue?": "При успешном изменении пароля, ваш FarmBot будет сброшен на заводские настройки, позволив вам перенастроить учетные данные для входа в аккаунт. Продолжить?",
    ...
    "Auth: Bad email or password.": "Принят запрос на смену владельца.",
    "BOOTING": "ЗАГРУЗКА",
