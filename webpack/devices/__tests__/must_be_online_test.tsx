...
describe("<MustBeOnline/>", function () {
  it("Covers content when status is 'unknown'", function () {
    const elem = <MustBeOnline networkState="down" botState={"sync_now"}>
      <span>Covered</span>
    </MustBeOnline>;
  ...
  it("Uncovered when locked open", function () {
    const elem = <MustBeOnline networkState="down" botState={"sync_now"} lockOpen={true}>
      <span>Uncovered</span>
    </MustBeOnline>;
    const overlay = shallow(elem).find("div");
  ...
  it("Doesn't show banner", function () {
    const elem = <MustBeOnline networkState="down" botState={"sync_now"} hideBanner={true}>
      <span>Uncovered</span>
    </MustBeOnline>;
    const overlay = shallow(elem).find("div");
    expect(overlay.hasClass("unavailable")).toBeTruthy();
