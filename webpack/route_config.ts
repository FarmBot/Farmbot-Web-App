...
export const designerRoutes: PlainRoute = {
  ...
  childRoutes: [
    ...
    page("plants/create_point",
      ...
      "CreatePoints"),
    page("saved_gardens/templates",
      () => import("./farm_designer/plants/plant_inventory"),
      "Plants"),
    page("saved_gardens/templates/:plant_template_id",
      () => import("./farm_designer/plants/plant_info"),
      "PlantInfo"),
    page("saved_gardens/templates/:plant_template_id/edit",
      () => import("./farm_designer/plants/edit_plant_info"),
      "EditPlantInfo"),
    page("saved_gardens",
      () => import("./farm_designer/saved_gardens/saved_gardens"),
      "SavedGardens"),
    page("saved_gardens/:saved_garden_id",
      () => import("./farm_designer/saved_gardens/saved_gardens"),
      "SavedGardens"),
