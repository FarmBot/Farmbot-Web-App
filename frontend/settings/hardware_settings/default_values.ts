...
const DEFAULT_FIRMWARE_CONFIG_VALUES: Record<NumberFirmwareConfigKey, number> = {
  ...
  ["movement_calibration_retry_x" as NumberFirmwareConfigKey]: 3,
  ["movement_calibration_retry_y" as NumberFirmwareConfigKey]: 3,
  ["movement_calibration_retry_z" as NumberFirmwareConfigKey]: 3,
